export const FIELD_DEFINITIONS = {
  ...
  conversion_rate: { label: '转化率 (%)', type: 'number', required: true, step: '0.01', hint: '可保留两位小数' },
  ad_spend: { label: '投放消耗', type: 'number', required: false },
  roi: { label: '投产比 / ROI', type: 'number', required: false, step: '0.01', hint: '可保留两位小数' },
  refund_rate: { label: '退款率 (%)', type: 'number', required: true, step: '0.01', hint: '可保留两位小数' },
