...
def _markdown_to_word_body(markdown: str) -> str:
    ...
    while i < len(lines):
        ...
        if line.startswith("# "):
            ...
            body.append(_quote(line[2:].strip()))
        elif line.startswith("- "):
...
<w:styles xmlns:w="http://schemas.openxmlformats.org/wordprocessingml/2006/main">
  ...
  <w:style w:type="paragraph" w:styleId="QuoteBox"><w:name w:val="Quote Box"/><w:pPr><w:spacing w:before="120" w:after="140" w:line="330" w:lineRule="auto"/></w:pPr><w:rPr><w:b/><w:sz w:val="23"/><w:color w:val="1D4ED8"/></w:rPr></w:style>
